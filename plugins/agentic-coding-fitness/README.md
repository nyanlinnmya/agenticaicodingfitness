...
It's 8 bite-sized **skills**, one per big concept. Each skill:
...
> The examples reference the real code in this repo's `week2/ … week14/` folders. Clone the repo alongside installing the plugin to run them directly.
...
- **"I want it to use my data":** 5 → 7.
- **"Just give me the big picture":** 8 (start here, it maps everything).
